...
public class ParcelableConverterTest {
  ...
  private java.lang.annotation.Annotation[] javaAnnotations;
  ...
  public void before() throws NoSuchMethodException {
    ...
    List<Annotation> result = ParcelableConverter.getAnnotationsFromArray(javaAnnotations);
  ...
  public void getTestCaseFromDescription_returnsTestCase() throws TestEventException {
    ...
    TestCase testCase = getTestCaseFromDescription(description);
    ...
    assertThat(testCase.methodAnnotations.get(0).name)
        .isEqualTo(javaAnnotations[0].annotationType().getCanonicalName());
  }

  @Test
  public void getTestCaseFromDescription_invalidDescription_throws() {
    try {
      getTestCaseFromDescription(Description.TEST_MECHANISM);
      fail("Expected TestEventException");
    } catch (TestEventException ignore) {
